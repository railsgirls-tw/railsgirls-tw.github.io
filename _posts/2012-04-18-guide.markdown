...
Rails Girls 於 2010 年底在赫爾辛基成立。本來只是個一次性的活動，從未想到世界各地會出現有這麼多的分部！本教學把所有資源集結起來，來幫助你舉辦首場活動。

如果你想舉辦一場活動，從填寫 [http://railsgirls.com/inyourcity](http://railsgirls.com/inyourcity) 開始，我們的人將會聯絡妳。
...
Rails Girls 活動是非盈利性的。我們不跟參加者收費，也不會支付報酬給教練或是講師。參加者不需要有任何的程式知識，也沒有年齡限制。只要要有台筆電和一點好奇心就可參加！

為期兩天的活動包含了大量的小組協作，以及一些簡短的演講，重點介紹編程、設計、以及 web。將不會有八股的辯論或是演講 —— 精神是務實與隨性的。抽象的概念越少越好，參與精神越多越好。

#### Rails Girls 哲學

* 讓人格特質散發光彩，將遠景銘記在心。反覆解釋一個觀念時，記得將觀念與大環境來看。

* 網路是人打造出來的，不會因為你的牛刀小試而崩壞。我們要一直展現人性面：鼓勵教練討論開源社群、偶像以及啟發他們的故事。

* 複製貼上是王道！不是最重要的 —— 一天是學不會的中文的，用同樣的角度看，妳只能學會在程式領域裡，如何表達想法以及一些基本的術語。活動的目標是能有些馬上能看到的成效展現給學員。
...
每場 Rails Girls 活動由一場“安裝節慶”開始，將活動所需的環境安裝在女孩們的電腦上。 這裡有準備好的[教學指南](http://guides.railsgirls.com/install)。安裝節慶可以包含簡短的演講，但重點是給女孩提供點氣泡酒，將隔天活動所需的一切準備好，讓女孩們互相認識。時間應該是可以靈活調整的 —— 你知道該怎樣分配時間，才對參與者最好。我們有在週末與工作日辦過活動的經驗。連續兩個晚上（下午四點至晚上十點）可能會更符合你的需求。
...
想一些活動來打破尷尬：讓女孩們在便利貼寫下為什麼來參加活動，或是畫她們夢想中的 web 應用。
...
*提示* 預留足夠的時間讓大家混熟，以及為昨天仍有安裝問題的學員解決問題。分發講義，蒐集便當練習會用到的縮寫。

10:00 - 10:10 歡迎致詞

*提示* 提一下贊助商，展示即將打造的 web 應用，簡介什麼是寫程式。

10:30 - 11:00 用戶體驗 (UX)工作坊

11:00 - 11:30 編程簡介

*提示* 請一位教練講解編程。解釋為什麼用 Rails 要懂點基本的 Ruby。

主題應包含：

* 靜態與動態網站的差別：web app 是什麼？

* 程式語言是什麼？Rails 是什麼？

* 會用到的工具：瀏覽器、終端、程式碼編輯器、文件夾結構。
...
慢慢的走一遍 [Rails Girls 教學 APP](http://guides.railsgirls.com/app")。記得停下來解釋你在做什麼以及重要的觀念。試著簡單的解釋觀念，即便是犧牲了準確性。不需要討論高深的概念。試著回答她們的問題，過於艱澀或超出範圍時，應直接跳過。不是要教她們完美的編程技巧，而是讓她們看看事情是如何做的。先打造 web app 出來，接著才想怎麼做好。
...
教練也是人。他們也是第一次當教練。教學對他們來說可能很難或是怯場，記得要在不同情況下，比如教練有困難時即時幫助他們，即便只是鼓勵與支持。
...
演讲的题目可以如下（但不仅限于这些）： + 女性职业程序员谈谈在这个行业中工作的体会。

19:00 After party

*提示：*
邀請所有人，包括當地的開發者、男孩子們、以及沒被錄取的參與者來加入！
